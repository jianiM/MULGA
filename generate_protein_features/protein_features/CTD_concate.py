...
def get_config():
    ...
    parse.add_argument('-ctdc_path', '--ctdc_path_topofallfeature', type=str, default="./CTDC_feature.xlsx")
    parse.add_argument('-ctdt_path', '--ctdt_path_topofallfeature', type=str, default="./CTDT_feature.xlsx")
    parse.add_argument('-ctdd_path', '--ctdd_path_topofallfeature', type=str, default="./CTDD_feature.xlsx") 
