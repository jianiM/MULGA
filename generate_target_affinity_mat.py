...
if __name__=="__main__":
    ...
    aac = pd.read_excel(AAC_path,header=None).values
    ctd = pd.read_excel(CTD_path,header=None).values
    moran = pd.read_excel(Moran_path,header=None).values
    paac = pd.read_excel(PAAC_path,header=None).values
