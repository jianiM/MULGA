...
def get_config():
    ...
    parse.add_argument('-num_filters', '--num_filters_topofallfeature', type=int, default=6)
    ...
    parse.add_argument('-lr', '--lr_topofallfeature', type=float, nargs='?', default=0.00001)
    ...
    parse.add_argument('-epoch_num', '--epoch_num_topofallfeature', type=int, default=20)
